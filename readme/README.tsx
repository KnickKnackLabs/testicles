...
import { verticalChain } from "./diagrams";
...
const trustChain = verticalChain([
  { label: "Or Ricon",  note: "root of trust" },
  { label: "Zeke",      note: "certifies ↓" },
  { label: "Baby Joel", note: "certified ✓" },
]);
